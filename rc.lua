...
--         {description = "run gui editor", group = "super"}),
    ...
    awful.key({ modkey }, "a", function () awful.util.spawn( terminal ) end,
...
awful.spawn.with_shell("nitrogen --restore")  --for wallpaper
awful.spawn.with_shell("~/.config/awesome/autostart.sh")  --this control whole autostart (superb)
awful.spawn.with_shell("picom -b --config  $HOME/.config/awesome/picom.conf")  --for transperency
